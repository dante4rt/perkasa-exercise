                    ...
                    <div className="flex gap-6 ">
                        ...
                        <div className="flex flex-col gap-1">
                            <div className="ml-0 pb-2">
                                <div className="justify-between w-12/12 flex gap-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-t-md focus:ring-blue-500 focus:border-blue-500 px-2 py-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            <div className="flex flex-col gap-1 overflow-scroll max-h-96">
                                <div className="ml-0 flex gap-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xs focus:ring-blue-500 focus:border-blue-500 w-full px-2 py-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    7.30 am - 3.25 am
                        ...
                        <div>
                            <div className="flex flex-col">
                                <div className="overflow-x-auto sm:-mx-6 lg:-mx-8 pr-0.5">
                                            ...
                                            <table className="min-w-full border text-center text-sm font-light dark:border-neutral-500">
                                                ...
                                                <tbody>
                                                    <tr className="border-b dark:border-neutral-500">
                                                        ...
                                                        <td className="whitespace-nowrap border-r font-semibold px-3 text-left bg-gray-100 py-2 dark:border-neutral-500">
                                                            7 am - <br />
                                                            3 pm
                                                        </td>
