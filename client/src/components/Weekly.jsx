                    ...
                    <div className="flex">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex flex-col gap-1 overflow-y-auto max-h-96">
                                <div className="ml-2 flex gap-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xs focus:ring-blue-500 focus:border-blue-500 w-fit px-2 py-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    7.30 am - 3.25 am
