                ...
                <div className="overflow-y-auto py-5 px-3 h-full bg-[#0f1728] dark:bg-gray-800 flex flex-col justify-between">
                    ...
                    <div>
                        <NavLink to='/' className="flex items-center bg-[#0f1728] pl-2.5 mb-5">
                            ...
                            <span className="self-center text-xl font-semibold whitespace-nowrap text-white dark:text-white">PERKASA</span>
                        </NavLink>
                        <ul className="space-y-2">
                            ...
                            <li>
                                ...
                                >
                                    ...
                                    <span className="hover:cursor-pointer flex-1 ml-3 text-left text-white whitespace-nowrap">
                                        Leave
                                    </span>
                                </div>
                            </li>
